...
public class Field extends JPanel {
	...
	public Field(JLabel statusBar) {
		this.statusBar = statusBar;

		this.img = new Image[NUM_IMAGES];
		for (int i = 0; i < NUM_IMAGES; i++) {
			String path = "C:\\Users\\Torsten\\eclipse-workspace\\OOP\\src\\game\\img\\j" + i + ".gif";
	...
	public void paint(Graphics g) {
		...
		if (coveredCells == 0 && inGame) {
			inGame = false;
			statusBar.setText("Gewonnen!");
		} else if (!inGame) {
			statusBar.setText("Verloren!");
		}
	}
